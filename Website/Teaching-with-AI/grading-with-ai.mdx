...
To safeguard student intellectual property (IP) and personally identifiable information (PII), faculty should use only AI grading tools that have been approved by the BYU-Idaho AI Executive Committee. [See approved tools](/Resources/approved-tools).
